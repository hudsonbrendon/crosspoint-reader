# Project Vision & Scope: inkpoint

The goal of inkpoint is to create an efficient, open-source reading experience for the Xteink X4. We believe a
...
While I appreciate the desire to add new and exciting features to inkpoint, inkpoint is designed to be
