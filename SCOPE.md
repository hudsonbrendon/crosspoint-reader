# Project Vision & Scope: InkPoint Reader

The goal of InkPoint Reader is to create an efficient, open-source reading experience for the Xteink X4. We believe a
...
*These features align with InkPoint's goals but are impractical on the current hardware or produce poor UX.*
...
While I appreciate the desire to add new and exciting features to InkPoint Reader, InkPoint Reader is designed to be
