...
constexpr char STATE_FILE_BIN[] = "/.inkpoint/state.bin";
constexpr char STATE_FILE_JSON[] = "/.inkpoint/state.json";
constexpr char STATE_FILE_BAK[] = "/.inkpoint/state.bin.bak";
}  // namespace

InkPointState InkPointState::instance;

bool InkPointState::isRecentSleep(uint16_t idx, uint8_t checkCount) const {
...
void InkPointState::pushRecentSleep(uint16_t idx) {
...
bool InkPointState::loadFromBinaryFile() {
  HalFile inputFile;
