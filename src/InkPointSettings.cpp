...
InkPointSettings InkPointSettings::instance;
...
constexpr char SETTINGS_FILE_BIN[] = "/.inkpoint/settings.bin";
constexpr char SETTINGS_FILE_JSON[] = "/.inkpoint/settings.json";
constexpr char SETTINGS_FILE_BAK[] = "/.inkpoint/settings.bin.bak";
constexpr char LANG_FILE_BIN[] = "/.inkpoint/language.bin";
constexpr char LANG_FILE_BAK[] = "/.inkpoint/language.bin.bak";

// Convert legacy front button layout into explicit logical->hardware mapping.
void applyLegacyFrontButtonLayout(InkPointSettings& settings) {
  switch (static_cast<InkPointSettings::FRONT_BUTTON_LAYOUT>(settings.frontButtonLayout)) {
    case InkPointSettings::LEFT_RIGHT_BACK_CONFIRM:
      settings.frontButtonBack = InkPointSettings::FRONT_HW_LEFT;
      settings.frontButtonConfirm = InkPointSettings::FRONT_HW_RIGHT;
      settings.frontButtonLeft = InkPointSettings::FRONT_HW_BACK;
      settings.frontButtonRight = InkPointSettings::FRONT_HW_CONFIRM;
      break;
    case InkPointSettings::LEFT_BACK_CONFIRM_RIGHT:
      settings.frontButtonBack = InkPointSettings::FRONT_HW_CONFIRM;
      settings.frontButtonConfirm = InkPointSettings::FRONT_HW_LEFT;
      settings.frontButtonLeft = InkPointSettings::FRONT_HW_BACK;
      settings.frontButtonRight = InkPointSettings::FRONT_HW_RIGHT;
      break;
    case InkPointSettings::BACK_CONFIRM_RIGHT_LEFT:
      settings.frontButtonBack = InkPointSettings::FRONT_HW_BACK;
      settings.frontButtonConfirm = InkPointSettings::FRONT_HW_CONFIRM;
      settings.frontButtonLeft = InkPointSettings::FRONT_HW_RIGHT;
      settings.frontButtonRight = InkPointSettings::FRONT_HW_LEFT;
      break;
    case InkPointSettings::BACK_CONFIRM_LEFT_RIGHT:
    default:
      settings.frontButtonBack = InkPointSettings::FRONT_HW_BACK;
      settings.frontButtonConfirm = InkPointSettings::FRONT_HW_CONFIRM;
...
void InkPointSettings::validateFrontButtonMapping(InkPointSettings& settings) {
...
uint8_t InkPointSettings::sleepTimeoutEnumToMinutes(const uint8_t legacyValue) {
  switch (legacyValue) {
    case SLEEP_1_MIN:
      return 1;
    case SLEEP_5_MIN:
...
bool InkPointSettings::saveToFile() const {
  Storage.mkdir("/.inkpoint");
  return JsonSettingsIO::saveSettings(*this, SETTINGS_FILE_JSON);
}

bool InkPointSettings::loadFromFile() {
  // Try JSON first
...
bool InkPointSettings::migrateLanguageBinaryFile() {
...
bool InkPointSettings::loadFromBinaryFile() {
  HalFile inputFile;
  ...
  if (frontButtonMappingRead) {
    InkPointSettings::validateFrontButtonMapping(*this);
  } else {
...
float InkPointSettings::getReaderLineCompression() const {
...
unsigned long InkPointSettings::getSleepTimeoutMs() const {
...
int InkPointSettings::getRefreshFrequency() const {
...
int InkPointSettings::getReaderFontId() const {
