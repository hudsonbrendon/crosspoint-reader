...
#include "network/InkPointWebServer.h"
...
/**
 * InkPointWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the InkPointWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class InkPointWebServerActivity final : public Activity {
