#include "InkPointWebServerActivity.h"
...
void InkPointWebServerActivity::onEnter() {
  Activity::onEnter();
...
void InkPointWebServerActivity::onExit() {
  Activity::onExit();
...
void InkPointWebServerActivity::onNetworkModeSelected(const NetworkMode mode) {
...
void InkPointWebServerActivity::onWifiSelectionComplete(const bool connected) {
...
void InkPointWebServerActivity::startAccessPoint() {
...
void InkPointWebServerActivity::startWebServer() {
  LOG_DBG("WEBACT", "Starting web server...");

  // Create the web server instance
  webServer.reset(new InkPointWebServer());
  webServer->begin();
...
void InkPointWebServerActivity::loop() {
...
void InkPointWebServerActivity::render(RenderLock&&) {
...
void InkPointWebServerActivity::renderServerRunning() const {
  const auto& metrics = UITheme::getInstance().getMetrics();
  const auto pageWidth = renderer.getScreenWidth();
...
void InkPointWebServerActivity::renderWifiIndicator(int subHeaderTop) const {
