...
This guide explains how to connect your InkPoint Reader to WiFi and use the built-in web server to upload files from your computer or phone.

## Overview

InkPoint Reader includes a built-in web server that allows you to:
...
1. Ensure your computer is connected to the **same WiFi network** as your InkPoint Reader
...
1. Ensure your phone/tablet is connected to the **same WiFi network** as your InkPoint Reader
...
1. Press the **Back** button on your InkPoint Reader
